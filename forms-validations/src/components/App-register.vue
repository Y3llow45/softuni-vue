  ...
  <div class="container d-flex pt-5">	
		<form class="flex-fill">
          ...
          <template v-if="$v.password.$error">
            ...
            <div v-else-if="!$v.password.minLength">Password should be atleast 8 characters</div>
          </template>
					<div class="form-group">
          ...
          <template v-if="$v.age.$error">
            ...
            <div v-else-if="!$v.age.between">Invalid age</div>
          </template>
				</div>
			</div>
			<div class="row">
        ...
        <template v-if="$v.description.$error">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
					<div class="form-group">
						<h3>Skill Set</h3>
						<label for="js"><input type="checkbox" id="js" value="JavaScript" v-model="skillSet" @blur="$v.skillSet.$touch"> JavaScript
						</label> <label for="csharp"><input type="checkbox" id="csharp" value="C#" v-model="skillSet" @blur="$v.skillSet.$touch"> C#
						</label> <label for="java"><input type="checkbox" id="java" value="Java" v-model="skillSet" @blur="$v.skillSet.$touch"> Java
						</label> <label for="php"><input type="checkbox" id="php" value="PHP" v-model="skillSet" @blur="$v.skillSet.$touch"> PHP
						</label>
					</div>
				</div>
          <div v-if="!$v.skillSet.required">SkillSet is required</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 form-group"><label
						for="male">
            <input type="radio" id="male" value="Male" v-model="gender" @blur="$v.gender.$touch"> Male
					</label> <label for="female">
            <input type="radio" id="female" value="Female" v-model="gender" @blur="$v.gender.$touch"> Female
					</label>
				</div>
